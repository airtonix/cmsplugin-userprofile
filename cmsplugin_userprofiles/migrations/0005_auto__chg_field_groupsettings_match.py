...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupSettings.match'
        db.alter_column('cmsplugin_groupsettings', 'match', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GroupSettings.match'
        raise RuntimeError("Cannot reverse this migration. 'GroupSettings.match' and its values cannot be restored.")
    ...
    models = {
        ...
        'cmsplugin_userprofile.groupsettings': {
            ...
            'match': ('django.db.models.fields.CharField', [], {'default': "'or'", 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'sort': ('django.db.models.fields.CharField', [], {'default': "'date_joined'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'sort_direction': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
