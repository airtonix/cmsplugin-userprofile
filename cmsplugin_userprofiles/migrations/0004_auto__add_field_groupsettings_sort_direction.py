...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupSettings.sort_direction'
        db.add_column('cmsplugin_groupsettings', 'sort_direction', self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupSettings.sort_direction'
        db.delete_column('cmsplugin_groupsettings', 'sort_direction')
