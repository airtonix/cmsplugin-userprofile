...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupSettings.operator'
        db.delete_column('cmsplugin_groupsettings', 'operator')

        # Adding field 'GroupSettings.match'
        db.add_column('cmsplugin_groupsettings', 'match', self.gf('django.db.models.fields.CharField')(default='and', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'GroupSettings.operator'
        raise RuntimeError("Cannot reverse this migration. 'GroupSettings.operator' and its values cannot be restored.")

        # Deleting field 'GroupSettings.match'
        db.delete_column('cmsplugin_groupsettings', 'match')
